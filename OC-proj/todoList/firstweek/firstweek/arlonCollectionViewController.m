//
//  NSObject+arlonCollectionViewController.m
//  firstweek
//
...
@implementation arlonCollectionViewController
...
- (void)viewDidLoad {
    ...
    //注册cell
    [self.myCollection registerClass:[arlonCollectionViewCell class] forCellWithReuseIdentifier:CELL_INDI];
...
{
    arlonCollectionViewCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:CELL_INDI forIndexPath:indexPath];
